...
def creating_dev_files_subset(path1):
    # Charger le fichier filtered_test.tsv en utilisant pandas
    filtered_dev_df = pd.read_csv('./tsv_files/filtered_dev.tsv', sep='\t')
    # Définir le path3
    path3 = './en_dev_full_subset/'
    ...
    for index, row in filtered_dev_df.iterrows():
